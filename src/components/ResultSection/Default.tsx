        ...
        <div className="default">
            <div className="default-wrapper">
                ...
                <div>
                    ...
                    Learn more about <a href="#!" target="_blank" rel="noreferrer">our algorithm used at GitHub Rater</a>.
                </div>
                <div>
                ...
                <div>
                    ...
                    Check out <a href="#!" target="_blank" rel="noreferrer">GitHub Rater's Repository</a> at GitHub!
                </div>
            </div>
        </div>
    )
